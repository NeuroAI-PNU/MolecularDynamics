...
if __name__=="__main__":
    ...
    with open("240822_Final_topology_50ns_PME_6.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("240822_Final_trajectory_50ns_PME_6.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./240822_Final_trajectory_50ns_PME_6.xtc"
