...
if __name__=="__main__":
    ...
    # prepare protein
    prepare_protein = prepare_protein("./rank9.pdb", ignore_missing_residues=False)
    ...
    with open("240822_Final_topology_50ns_PME_9.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("240822_Final_trajectory_50ns_PME_9.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./240822_Final_trajectory_50ns_PME_9.xtc"
