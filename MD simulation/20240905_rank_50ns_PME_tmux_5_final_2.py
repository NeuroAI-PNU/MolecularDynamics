...
if __name__=="__main__":
    ...
    # prepare protein
    prepare_protein = prepare_protein("./rank6.pdb", ignore_missing_residues=False)
    ...
    with open("240905_Final_topology_50ns_PME_6.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("240905_Final_trajectory_50ns_PME_6.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./240905_Final_trajectory_50ns_PME_6.xtc"
