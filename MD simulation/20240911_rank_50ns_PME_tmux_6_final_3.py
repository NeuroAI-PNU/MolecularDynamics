...
if __name__=="__main__":
    ...
    # prepare protein
    prepare_protein = prepare_protein("./rank7.pdb", ignore_missing_residues=False)
    ...
    with open("240911_Final_topology_50ns_PME_7.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("240911_Final_trajectory_50ns_PME_7.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./240911_Final_trajectory_50ns_PME_7.xtc"
